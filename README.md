...
- **Mercado Pago SDK v3** — Checkout Pro + QR POS dinámico
...
4. **QR** — muestra QR POS (app Mercado Pago) y link de Checkout Pro; polling cada 3 s detecta el pago aprobado; timeout de 60 s
...
# QR POS (opcional — sin esto solo funciona Checkout Pro)
...
│       ├── clientes/
│       ├── sesiones/
│       ├── pagos/              # crear, estado, confirmar, webhook
│       └── admin/
└── styles/
    └── globals.css
